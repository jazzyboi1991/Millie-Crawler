...
// main.ts
var BookHighlighterPlugin = class extends import_obsidian.Plugin {
  async onload() {
    this.addCommand({
  ...
  async fetchHighlightsAndSave() {
    try {
      const res = await axios_default.get("http://localhost:3000/fetch-highlights");
...
${entries.join("\n")}`;
      ...
      new import_obsidian.Notice("\u{1F4D8} \uD558\uC774\uB77C\uC774\uD2B8 \uAC00\uC838\uC624\uAE30 \uC644\uB8CC!");
    } catch (e) {
      new import_obsidian.Notice("\u274C \uD558\uC774\uB77C\uC774\uD2B8 \uBD88\uB7EC\uC624\uAE30 \uC2E4\uD328");
      console.error(e);
    }
  }
};
